...
import { isLikedComment } from '../features/actions/isCommentLikedSlice';

const PostNav = () => {
    const toast = useToast()
    const dispatch = useDispatch();
    const color = useSelector((state) => state.iscommentliked.color)

    const handleLikeClick = () => {
        console.log("Liked")
        dispatch(isLikedComment());
    };
  ...
  return (
    <div className = "flex gap-3 mt-3 mb-5" onClick={(e) => e.preventDefault()}>
